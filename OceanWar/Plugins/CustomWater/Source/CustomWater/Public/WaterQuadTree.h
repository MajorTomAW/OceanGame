...
struct FWaterQuadTree 
{
	...
	void AddFarMesh(const UMaterialInterface* InFarMeshMaterial, double InFarDistanceMeshExtent, double InFarDistanceMeshHeight, double InCenterMeshExtent, FVector2d InWaterCenter);
